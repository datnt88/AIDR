...
#	print("Padding sequences....")
	...
	# Applying adapation model
	#----------------------------------------------------------------
	# Loading In and Out domain data
...
#	print("Padding sequences....")
	...
	for i in range (1,count+1):
		...
		model_name_X = options.model_dir + "cnn-normal-model-X-" + str(i) + "-" + optimizer + "-" + str(options.nb_filter) + "-" + str (options.tune_emb) +\
		"-" + loss + "-" + str (options.minibatch_size) + "-" + str(options.dropout_ratio) + "-init-" + str (options.init_type) + "-" +\
